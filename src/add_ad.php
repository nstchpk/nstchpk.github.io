...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
        ...
        if (empty($errors)) {
            ...
            // Уникальное имя с оригинальным расширением
    ...
    if (empty($errors)) {
        try {
            $sql = "INSERT INTO ads (user_id, ads_title, ads_description, ads_price, ads_photo, created_at)
                    VALUES (?, ?, ?, ?, ?, NOW())";
